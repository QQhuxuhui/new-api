        ...
        >
          <Form.Section text={t('通用设置')}>
            ...
            <Row gutter={16}>
              ...
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
                <Form.Switch
                  field={'PlanSystemEnabled'}
                  label={t('套餐系统')}
                  extraText={t('启用后用户可使用套餐配额，优先扣除套餐配额而非余额')}
                  size='default'
                  checkedText='｜'
                  uncheckedText='〇'
                  onChange={handleFieldChange('PlanSystemEnabled')}
                />
              </Col>
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
                <Form.Switch
                  ...
                  label={t('启用Ping间隔')}
                  extraText={t('警告：启用保活后，如果已经写入保活数据后渠道出错，系统无法重试，如果必须开启，推荐设置尽可能大的Ping间隔')}
                  size='default'
                  checkedText='｜'
                  uncheckedText='〇'
                  onChange={handleFieldChange('general_setting.ping_interval_enabled')}
                />
              </Col>
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
                <Form.Input
                  ...
                  initValue={60}
                  placeholder={'60'}
                  onChange={handleFieldChange('general_setting.ping_interval_seconds')}
