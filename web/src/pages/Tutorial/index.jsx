...
const NoteBox = ({ type = 'info', title, children }) => {
  const styles = {
    ...
    success: 'border-green-200 bg-green-50 dark:border-green-500/40 dark:bg-green-950/30',
    warning: 'border-yellow-200 bg-yellow-50 dark:border-yellow-500/40 dark:bg-yellow-950/30',
  };
  ...
  return (
    <div className={`rounded-lg border p-3 sm:p-4 ${styles[type]}`}>
      {title && (
        <Text className={`block mb-2 font-medium text-sm sm:text-base ${textStyles[type]}`}>
          {title}
        </Text>
      )}
        ...
        <Card className="p-4 sm:p-6">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <Paragraph className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
              {t('tutorial.description', '跟着这个教程，你可以轻松在自己的电脑上安装并使用 Claude Code 和 OpenAI Codex。')}
            </Paragraph>
          </div>
          ...
          <div className="mb-8 sm:mb-12">
            ...
            {/* 步骤 1: 安装 Node.js */}
            <div className="mb-6 sm:mb-8">
              <StepTitle step={1} title={t('tutorial.step1.title', '安装 Node.js 环境')} />
              <Paragraph className="mb-4 text-sm sm:text-base text-gray-600 dark:text-gray-400">
                {t('tutorial.step1.description', 'Claude Code 需要 Node.js 环境才能运行。')}
              </Paragraph>
              ...
              {activeOS === 'windows' && (
                <NoteBox type="info" title="Windows 安装方法">
                  ...
                  <ol className="list-decimal ml-4 space-y-1">
                    <li>
                      打开浏览器访问 <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">https://nodejs.org/</code>
                    </li>
                    <li>点击 "LTS" 版本进行下载（推荐长期支持版本）</li>
                    <li>
                      下载完成后双击 <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">.msi</code> 文件
                    </li>
...
npm --version`} />
            ...
            {/* 步骤 2: 安装 Claude Code */}
            <div className="mb-6 sm:mb-8">
              <StepTitle step={2} title={t('tutorial.step2.title', '安装 Claude Code')} />
              <Paragraph className="mb-4 text-sm sm:text-base text-gray-600 dark:text-gray-400">
          ...
          <div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-6">
            <NoteBox type="success" title="🎉 配置完成！">
              ...
              <ul className="list-disc ml-4 mt-2 space-y-1">
                <li>Claude Code: 运行 <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">claude</code> 命令开始使用</li>
