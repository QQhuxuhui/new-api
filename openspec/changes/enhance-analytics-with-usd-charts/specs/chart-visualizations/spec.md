...
### Requirement: Consumption Analysis tab layout MUST include both chart and table

The Consumption Analysis tab SHALL display a line chart prominently at the top with an optional toggle to show/hide the detailed data table below.

#### Scenario: Consumption tab shows chart by default, table on demand

**Given** admin navigates to "Consumption Analysis" tab
**When** tab content loads
**Then** line chart is prominently displayed at top
**And** a "Show Table" toggle button appears below chart
**When** admin clicks "Show Table"
**Then** table expands below chart (chart remains visible)
**And** button changes to "Hide Table"

---

## REMOVED Requirements

None. This capability enhances the UI without removing functionality.
