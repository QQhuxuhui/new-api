...
type generatedVideoEntry struct {
	Video struct {
		URI string `json:"uri"`
	} `json:"video"`
}
...
type operationResponse struct {
	...
	Response struct {
		...
		GenerateVideoResponse struct {
			GeneratedVideos []generatedVideoEntry `json:"generatedVideos"`
			// Older API versions return generatedSamples instead of generatedVideos.
			GeneratedSamples []generatedVideoEntry `json:"generatedSamples"`
